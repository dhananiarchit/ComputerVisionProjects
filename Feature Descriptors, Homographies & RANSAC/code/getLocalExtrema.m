...
immin = imregionalmin(DoGPyramid,26);
immax = imregionalmax(DoGPyramid,26);


locs = abs(DoGPyramid)>th_contrast & PrincipalCurvature < th_r & (immax | immin);

[x,y,L] = ind2sub(size(DoGPyramid), find(locs));
